...
class CircleWinsRelationManager extends RelationManager
{
    protected static string $relationship = 'wins';

    public static function getTitle(Model $ownerRecord, string $pageClass): string
    {
        return __('filament.circle.wins_tab');
    }
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('cheers_count')
                    ->label(__('filament.circle.cheers_count'))
                    ->sortable(),
