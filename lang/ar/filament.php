...
return [
    ...
    'navigation' => [
        ...
        'circles_management' => 'إدارة الدوائر',
        'help_management' => 'إدارة محتاج رأيكم',
        'stories_management' => 'إدارة الحكايات',
        'wheel_management' => 'إدارة العجلة',
        'mood_management' => 'إدارة المزاج',
        'space_management' => 'إدارة مساحتي',
        'companion_management' => 'إدارة رفيق معلش',
    ...
    'resources' => [
        ...
        'circle' => 'الدوائر',
        'circle_singular' => 'دائرة',
        'circle_challenge' => 'تحديات الدوائر',
        'circle_challenge_singular' => 'تحدي دائرة',
        'help_ask' => 'محتاج رأيكم',
        'help_ask_singular' => 'سؤال',
        'story' => 'الحكايات',
        'story_singular' => 'حكاية',
        'story_category' => 'تصنيفات الحكايات',
        'story_category_singular' => 'تصنيف حكاية',
        'wheel_challenge' => 'تحديات العجلة',
        'wheel_challenge_singular' => 'تحدي العجلة',
        'mood' => 'المزاجات',
        'mood_singular' => 'مزاج',
        'daily_card_tip' => 'كروت سحبة النهاردة',
        'daily_card_tip_singular' => 'كارت سحبة',
        'achievement' => 'الإنجازات',
        'achievement_singular' => 'إنجاز',
        'room_decoration' => 'تزيينات البيت',
        'room_decoration_singular' => 'تزيين',
        'companion_suggestion' => 'اقتراحات الرفيق',
        'companion_suggestion_singular' => 'اقتراح رفيق',
        'companion_reply' => 'ردود الرفيق',
        'companion_reply_singular' => 'رد رفيق',
        'community_season' => 'مواسم المجتمع',
        'community_season_singular' => 'موسم المجتمع',
    ],

    // Circles
    'circle' => [
        'section_info' => 'بيانات الدائرة',
        'name' => 'الاسم',
        'name_ar' => 'الاسم (عربي)',
        ...
        'stories_tab' => 'الحكايات',
        'wins_tab' => 'المكاسب',
        'icebreakers_tab' => 'كسر الجليد',
        'author' => 'الكاتب',
        'anonymous' => 'مجهول',
        'body' => 'النص',
        'hearts_count' => 'القلوب',
        'cheers_count' => 'التشجيعات',
        'icebreaker_tag' => 'الوسم',
        'icebreaker_tag_ar' => 'الوسم (عربي)',
        'icebreaker_tag_en' => 'الوسم (إنجليزي)',
        'icebreaker_question' => 'السؤال',
        'icebreaker_question_ar' => 'السؤال (عربي)',
        'icebreaker_question_en' => 'السؤال (إنجليزي)',
    ],

    // Circle challenges
    'circle_challenge' => [
        'section_info' => 'بيانات التحدي',
        'circle' => 'الدائرة',
        'title' => 'العنوان',
        ...
        'steps_tab' => 'الخطوات',
        'step_text' => 'الخطوة',
        'step_text_ar' => 'الخطوة (عربي)',
        'step_text_en' => 'الخطوة (إنجليزي)',
        'messages_tab' => 'الرسائل',
    ],

    // Help (محتاج رأيكم)
    'help_ask' => [
        'section_info' => 'بيانات السؤال',
        'circle' => 'الدائرة',
        'title' => 'السؤال',
        'body' => 'التفاصيل',
        'author' => 'صاحب السؤال',
        ...
        'status_open' => 'مفتوح',
        'status_closed' => 'مقفول',
        'replies_count' => 'عدد المشاركات',
        'replies_tab' => 'المشاركات',
        'reply_type' => 'النوع',
        'type_advice' => 'نصيحة',
        'type_experience' => 'تجربة',
        'votes_count' => 'الأصوات',
    ],

    // Stories
    'story' => [
        'section_info' => 'بيانات الحكاية',
        'author' => 'الكاتب',
        'anonymous' => 'مجهول',
        'category' => 'التصنيف',
        'circle' => 'الدائرة',
    ...
    'story_category' => [
        ...
        'reaction_emoji' => 'إيموجي التفاعل',
        'reaction_label_ar' => 'وصف التفاعل (عربي)',
        'reaction_label_en' => 'وصف التفاعل (إنجليزي)',
        'sort_order' => 'الترتيب',
    ],

    // Companion suggestions
    'companion_suggestion' => [
        'section_info' => 'بيانات الاقتراح',
        'text' => 'النص',
        'text_ar' => 'النص (عربي)',
    ...
    // Companion replies
    'companion_reply' => [
        'section_info' => 'بيانات الرد',
        'text' => 'النص',
        'text_ar' => 'النص (عربي)',
        'text_en' => 'النص (إنجليزي)',
        'is_greeting' => 'رسالة ترحيب',
        'weight' => 'الوزن',
    ],

    // Companion settings
    'companion_settings' => [
        'nav' => 'إعدادات رفيق معلش',
        'saved' => 'تم حفظ الإعدادات',
        'save' => 'حفظ',
        'banner_section' => 'لافتة المساعدة',
        'presence_section' => 'الحضور والخط الساخن',
        'help_banner_title_ar' => 'عنوان لافتة المساعدة (عربي)',
        'help_banner_title_en' => 'عنوان لافتة المساعدة (إنجليزي)',
        'help_banner_body_ar' => 'نص لافتة المساعدة (عربي)',
        'help_banner_body_en' => 'نص لافتة المساعدة (إنجليزي)',
        'hotline_number' => 'رقم الخط الساخن',
        'presence_label_ar' => 'وصف الحضور (عربي)',
        'presence_label_en' => 'وصف الحضور (إنجليزي)',
    ],

    // Community seasons
    'community_season' => [
        'section_info' => 'معلومات الموسم',
        'name' => 'الاسم',
        'name_ar' => 'الاسم (عربي)',
        'name_en' => 'الاسم (إنجليزي)',
        'goal_leaves' => 'الهدف (أوراق)',
        'leaves_count' => 'الأوراق',
        'starts_at' => 'يبدأ في',
        'ends_at' => 'ينتهي في',
        'milestones_tab' => 'المراحل',
        'threshold' => 'الحد',
        'label' => 'العنوان',
    ...
    'achievement' => [
        ...
        'name_en' => 'الاسم (إنجليزي)',
        'criterion' => 'الشرط',
        'criterion_ar' => 'الشرط (عربي)',
        'criterion_en' => 'الشرط (إنجليزي)',
        'sort_order' => 'الترتيب',
    ],

    // Room decorations
    'room_decoration' => [
        'section_info' => 'بيانات التزيين',
        'key' => 'المفتاح',
        'title' => 'الاسم',
        'title_ar' => 'الاسم (عربي)',
    ...
    'wheel_challenge' => [
        'section_info' => 'بيانات التحدي',
        'segment_emoji' => 'إيموجي القطاع',
        'pill_label' => 'وسم التحدي',
        'pill_label_ar' => 'وسم التحدي (عربي)',
        'pill_label_en' => 'وسم التحدي (إنجليزي)',
        'title' => 'العنوان',
        'title_ar' => 'العنوان (عربي)',
        'title_en' => 'العنوان (إنجليزي)',
        'compose_hint_ar' => 'تلميح الكتابة (عربي)',
        'compose_hint_en' => 'تلميح الكتابة (إنجليزي)',
        'room_banner_ar' => 'لافتة الأوضة (عربي)',
        'room_banner_en' => 'لافتة الأوضة (إنجليزي)',
        'color' => 'اللون',
        'bg_color' => 'لون الخلفية',
        'spins_count' => 'عدد اللفّات',
        'responses_count' => 'الردود',
        'room_messages_count' => 'رسائل الأوضة',
        'laugh_count' => 'الضحكات',
        'heart_count' => 'القلوب',
        'responses_tab' => 'الردود',
        'room_messages_tab' => 'رسائل الأوضة',
        'author' => 'الكاتب',
        'anonymous' => 'مجهول',
        'body' => 'النص',
    ],
